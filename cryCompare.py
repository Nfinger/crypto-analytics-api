...
class Price:
	...
	def price(self, from_curr, to_curr, e=None, extraParams=None, sign=False, tryConversion=True, markets=None):
		return self.__get_price(self.__priceurl, from_curr, to_curr, e, extraParams, sign, tryConversion, markets)
